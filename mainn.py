...
async def main(user_id, num_proxies_to_use):
    ...
    num_proxies_to_use = min(num_proxies_to_use, len(all_proxies))
...
if __name__ == '__main__':
    ...
    num_proxies_to_use = int(sys.argv[2]) if len(sys.argv) > 2 else 1
    asyncio.run(main(user_id, num_proxies_to_use))
